...
class PHPMailer {
 ...
 // public $From              = 'root@localhost';
	 public $From              = 'marshadsaleem@tataelxsi.co.in';
  /**
   * Sets the From name of the message.
   * @var string
   */
  //public $FromName          = 'Root User';
	public $FromName          = 'Mohd Arshad Saleem';
  /**
   * Sets the Sender email (Return-Path) of the message.  If not empty,
   * will be sent via -f to sendmail or as 'MAIL FROM' in smtp mode.
   * @var string
   */
  public $Sender            = 'marshadsaleem@tataelxsi.co.in';
   ...
   * @var string
   */
  public $Host        = 'pod51022.outlook.com';
   ...
   * @var string
   */
  public $Username     = 'marshadsaleem@tataelxsi.co.in';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password     = 'rxf92480@B';
