...
<div style="width:120px; float:left; text-align:center; border-right:1px solid #E1E1E1; padding-left:5px; padding-top:10px; line-height:30px;"><?php if($user_status==1) {  ?><a href="#" onClick="uesr_status(0)"><img src="images/activate.jpg" height="15px" width="15px"></a><?php  } else { ?> <a href="#" onClick="uesr_status(1)"><img src="images/deactivate.jpg" height="15px" width="15px"></a> <?php }?></div>
