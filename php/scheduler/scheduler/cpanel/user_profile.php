<?php session_start(); 
 ...
 $queryse=mysql_query("SELECT `first_name`,`last_name`,`mail_id`,`mobile_number`,`username`,`password` FROM `sm_user_registor` WHERE id='$useid' AND user_status=1");
...
<form name="registration_form" method="post" action="adminprocess.php?task=user_reg" >
<div class="reg_top">
